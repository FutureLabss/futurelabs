...
const SwiperComponent = dynamic(() => import("../ui/Swiper"), { ssr: false });
  ...
  return (
    <div className="bg-[#fff] gap-[1.875rem] flex flex-col px-[20px] md:px-[40px] xl:px-[80px] py-[25px] md:py-[40px] xl:py-[137px]">
      <div className="flex flex-col gap-2 w-full max-w-[495px]  md:pl-[4.25rem] relative z-[2]">
        <h2 className="absolute z-[-1] top-[-30px] xl:top-[-65px]  hidden md:block left-[-12px]">
          <svg
        ...
        <h2 className="text-[1.5rem] md:text-[3rem] text-[#093851] font-semibold ">
          Real Stories from Futurists
        </h2>
        <p className="text-[0.875rem] md:text-[1.25rem] text-[#105F89]">
