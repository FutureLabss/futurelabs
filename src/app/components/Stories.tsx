...
export default function Stories() {
  return (
    <div className='bg-[#FCFCFD] gap-[1.875rem] flex flex-col px-[20px] md:px-[40px] xl:px-[80px] py-[25px] md:py-[137px]'>
      <div className='flex flex-col gap-2 w-full max-w-[495px]  md:pl-[4.25rem] relative z-[2]' >
        <h2 className='absolute z-[-1] top-[-65px] hidden md:block left-[-12px]'><svg xmlns="http://www.w3.org/2000/svg" width="143" height="120" viewBox="0 0 143 120" fill="none">
          <g clip-path="url(#clip0_147_4095)">
