  ...
  return (
    ...
    <div className="grid-container items-start w-full overflow- ">
      {servicesData.map((service, index) => (
        <Link
          href={service.id === "service-2" ? "/academy" : "#"}
          className={`grid-item px-4 sm:px-4 pt-10 bg-cover bg-[#FFFFFF0F] rounded-[1.5rem] cursor-pointer border-2 border-transparent hover:border-2 hover:border-secondary-50 `}
          key={index}
        >
