  ...
  return (
    ...
    <div className="grid-container w-full overflow-hidden">
      {servicesData.map((service, index) => (
        <Link href={service.id === "service-2" ? "https://futurelabs-lms.vercel.app/" : "#"} className={`grid-item px-4 sm:px-4 pt-10 bg-cover bg-[#FFFFFF0F] rounded-[1.5rem] cursor-pointer border-2 hover:border-secondary-50 `} key={index} >
