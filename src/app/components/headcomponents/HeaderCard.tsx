...
export default function HeaderCard() {
  return (
    <div className="w-full  bg-white">
      <div className="flex flex-col lg:flex-row justify-between gap-12  xl:gap-[7.1rem] items-center px-[20px] md:px-[3rem] xl:px-[6rem] py-[5.0625rem] w-full">
        <div className="flex flex-col gap-4 xl:max-w-[32.75rem] w-full">
          <h2 className="text-primary-default text-[2rem] md:text-[2.5rem] xl:text-size-48 leading-[3.5rem] font-extrabold font-manrope">Want to be globally relevant?</h2>
          <p>
        ...
        <div className="w-full flex flex-col font-inter">
          ...
          <div className="bg-[#E3EAF9] w-full h-full gap-4 py-7 px-[20px] lg:px-[3rem] flex-col flex lg:justify-center lg:items-center ">
            {
              skillSets.map(skill => (
                <div className="flex flex-col xl:gap-4 py-[.875rem] px-[1rem] rounded-[1rem] bg-white xl:max-w-[475px] w-full xl:items-center" key={skill.id}>
