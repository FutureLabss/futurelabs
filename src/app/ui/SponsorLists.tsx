...
const sponsors = [
  ...
  { src: "/sponsors/Zenith.png", width: 67, height: 67, alt: "Zenith" },
  { src: "/sponsors/abemx.png", width: 108, height: 45, alt: "Abemx" },
  { src: "/sponsors/Alphapay.png", width: 162, height: 33, alt: "Alphapay" },
  { src: "/sponsors/CodeRigi.png", width: 154, height: 45, alt: "CodeRigi" },
];

const SponsorsList = () => {
  return (
    <div className="flex justify-center gap-4 w-full max-w-full">
